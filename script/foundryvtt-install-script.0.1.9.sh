...
echo " "
echo " "
echo "Foundry mit Node starten und in den Hintergrund schicken.. "
sleep 3
node $HOME/foundryuserdata/resources/app/main.js --dataPath=$HOME/foundrydata >/dev/null 2>&1 &
...
#sleep 3
#pm2 start foundryuserdata/resources/app/main.js
#pm2 startup
#pm2 save
...
echo " "
echo " "
echo "pm2 start, pm2 startup und pm2 save muss nach einem Serverneustart, oder manueller terminierung des Node Prozesses, manuell ausgeführt werden"
echo "Am besten jetzt noch das System neu starten"
echo "...Fertig! :)"
echo " "
